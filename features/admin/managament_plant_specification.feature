Feature: Managament plants specification
  ...
  Scenario: Don't found plant specification
    Given I am authenticated as "admin" using "admin"
    When I follow "Managament"
    And I follow "Plant Specification"
    When I fill in "query" with "basilium"
    And I press "Search"
    Then I should see "No results found."

  Scenario: Search plant specification
    Given I am authenticated as "admin" using "admin"
    When I follow "Managament"
    And I follow "Plant Specification"
    When I fill in "query" with "Asian basil"
    And I press "Search"
    Then I should see the following text in row:
      | Name        | Frequency |
      | Asian basil | 1         |

  Scenario: Edit plant specification
    Given I am authenticated as "admin" using "admin"
    When I follow "Managament"
    And I follow "Plant Specification"
    And I click "Edit" in the "Asian basil" row
    Then I should see "Edit Plant Specification"

  Scenario: Doesn't edit plant specification
    Given I am authenticated as "admin" using "admin"
    When I follow "Managament"
    And I follow "Plant Specification"
    And I click "Edit" in the "Asian basil" row
    And I fill in "Frequency days" with "2"
    And I fill in "Amount" with "0.55"
    And I follow "Back to listing"
    Then I should not see the following text in row:
      | Name        | Frequency days | Amount |
      | Asian basil | 2              | 0.55   |
  ...
  Scenario: Edit plant specification
    ...
    And I press "Save changes"
    Then I should see the following text in row:
      | Name        | Frequency days | Amount | Author       |
      | Asian basil | 2              | 0.55   | flower_lover |

  Scenario: Edit plant specification with blank name, frequency, frequency days and amount
    Given I am authenticated as "admin" using "admin"
    When I follow "Managament"
    And I follow "Plant Specification"
    And I click "Edit" in the "Asian basil" row
  ...
  Scenario: Edit plant specification with too long name
    Given I am authenticated as "admin" using "admin"
    When I follow "Managament"
    And I follow "Plant Specification"
    And I click "Edit" in the "Asian basil" row
  ...
  Scenario: Edit plant specification with too long latin name
    Given I am authenticated as "admin" using "admin"
    When I follow "Managament"
    And I follow "Plant Specification"
    And I click "Edit" in the "Asian basil" row
  ...
  Scenario: Edit plant specification with too long description
    Given I am authenticated as "admin" using "admin"
    When I follow "Managament"
    And I follow "Plant Specification"
    And I click "Edit" in the "Asian basil" row
  ...
  Scenario: Edit plant specification with too long place
    Given I am authenticated as "admin" using "admin"
    When I follow "Managament"
    And I follow "Plant Specification"
    And I click "Edit" in the "Asian basil" row
